...
# ╔═╡ 3676421e-9232-11f0-0ee5-c9aea9a149e2
begin
...
# ╔═╡ 5717b9cc-6a6e-4e0f-9862-b6b26bf624dd
@fromparent begin
	import *
	import >. MLJ
	import >. MLJTuning
...
# ╔═╡ 8d831d83-81a5-4b2a-8244-f04288a72589
begin
	GI50_DATA = "/home/davide/Lavoro/libraries/train-split-benchmark/Data/NCI-60/GI50.csv"
	GI50_SMILES = "/home/davide/Lavoro/libraries/train-split-benchmark/Data/NCI-60/nsc_smiles.csv"
end

# ╔═╡ bd4299a9-33df-4bce-b1b8-00c9e70f93db
    smi = CSV.read(GI50_SMILES, DataFrame)

# ╔═╡ cc4ad263-e87d-46e1-8853-3205519ba0fe
LINES= [
"MCF7",
"MDA-MB-231/ATCC",
"HS 578T",
...
# ╔═╡ b98d7bca-4bb2-41bc-ab48-adcf072a06e8
act = CSV.read(GI50_DATA, DataFrame) |>
	filter(:CONCENTRATION_UNIT => ==("M")) |> # Remove readings in  µg/ml or Volume
	filter(:CELL_NAME => in(LINES)) # Filter only the 60 current cell lines

# ╔═╡ 6b357625-ec40-4632-8ead-4cccf397b80c
act |>
	x -> x[!, :CELL_NAME] .* "_" .* string.(x[!, :NSC]) |>
		countmap
...
manifest_format = "2.0"
project_hash = "9de87e25bf5e1fcfd1e18ba6be72b05b56e80418"
